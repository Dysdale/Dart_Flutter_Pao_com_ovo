...
import 'dart:convert'; // Importação do dart:convert
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String _result = '';
  bool _isButtonPressed = false; // Variável para controlar o estado do botão
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Consulta de CEP - Diego Neves da Cruz - 24-11-2024'),
      ),
      backgroundColor: Colors.lightBlue[100], // Cor de fundo azul claro
      body: Padding(
